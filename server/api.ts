...
// Route pour les demandes de privatisation
app.post("/api/send-privatization", async (req, res) => {
            ...
            <div class="container">
              ...
              <div class="content">
                ...
                <p style="margin-left: 20px;">
                  ...
                  📧 <strong>restaurantleseven38@gmail.com</strong></p>
                
                <p style="margin-top: 30px;">Nous avons hâte de vous accompagner dans l'organisation de votre événement ! 🌿<br>
                <strong>L'équipe du Seven</strong></p>
